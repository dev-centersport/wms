...
export default function ModalConfirmacao({ visible, onClose, onConfirmar, quantidade }) {
  return (
      ...
      <View style={styles.overlay}>
        <View style={styles.modalBox}>
          ...
          <View style={styles.modalContent}>
            ...
            <Text style={styles.modalMessage}>Confirma registrar a ocorrência com {quantidade || '0'} unidade(s)?</Text>
